...
class GeneratePdf():
    ...
    def login(self, rfc, pwd):
        print('login....')
        rfc_input = self.wait_10.until(EC.presence_of_element_located(
                (By.XPATH, '//*[@id="IDPLogin"]/div[1]/div/input')))
        rfc_input.click()
        rfc_input.clear()
        rfc_input.send_keys(rfc)

        print('rfc_input=', rfc_input)
...
#         print('captchaInput=', captchaInput)
#         print('submit=', submit)
#         print('imageContainer=', imageContainer)
#         print('captchaImage=', captchaImage)
#         print('imgUrl=', imgUrl)
